...
Public Class BaseDatos
    ...
    ''' <sumary>
    ''' Encripta la cadena de conexion
    ''' </sumary>

    Public Sub EncriptaApp()
        Dim config As Configuration = ConfigurationManager.OpenExeConfiguration("Facturacion.exe")
    ...
    Private Sub Configurar()
        Try
            ...
            Me._CadenaConexion = ConfigurationManager.ConnectionStrings("CADENA_CONEXION").ConnectionString
    ...
    Public Function MapeadatasetSP(ByVal nombreProcedimiento As String, ByVal ntabla As String) As DataSet
        _Comando = _Factory.CreateCommand
        _adaptador = _Factory.CreateDataAdapter
        _Comando.Connection = Me._Conexion

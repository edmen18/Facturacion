...
#Region "Metodos"
    Public Function AgregarTipo_Producto() As Boolean
        ...
        db.CrearStoreProcedure("SP_TIPO_PRODUCTO_REGISTRA")
    ...
    Public Function Listar_Tipo_Producto(ByVal oDgv As DataGridView) As Boolean
        Dim db As BaseDatos = New BaseDatos()
        Dim dt As New Data.DataTable
        Try
            db.Conectar()
            db.CrearStoreProcedure("SP_TIPO_PRODUCTO_LISTA")
            Try
    ...
    Public Function LlenarComboTipoProducto(ByRef oCombo As Object) As Boolean
        Dim db As BaseDatos = New BaseDatos()
        Dim dt As New Data.DataTable
        Try
            db.Conectar()
            ...
            Try
                ...
                oCombo.Properties.ValueMember = "codi_tipr"
                oCombo.Properties.DisplayMember = "desc_tipr"
            Catch ex As Exception
                MessageBox.Show(ex.ToString, "Error", MessageBoxButtons.OK, MessageBoxIcon.Stop)
            End Try
            db.Desconectar()

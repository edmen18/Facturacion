...
Public Class cl_backup
    ...
    Public Function CreaBackup(ByVal oDirDestino As String, ByVal nameBD As String) As Boolean
        Try
            Dim db As BaseDatos = New BaseDatos()
            Dim csql As String = "BACKUP DATABASE [" & nameBD & "] TO  DISK = N'" & oDirDestino & "' WITH NOFORMAT, NOINIT,  NAME = N'" & nameBD & "-Completa Base de datos Copia de seguridad', SKIP, NOREWIND, NOUNLOAD,  STATS = 10"
            db.Conectar()

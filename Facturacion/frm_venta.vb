...
Public Class frm_venta
    ...
    Private Sub btnNuevo_Click(sender As System.Object, e As System.EventArgs) Handles btnNuevo.Click
        ...
        LimpiarCajas()
        HabilitarCajas()
        Me.txtCodigo.EditValue = "VE" & Format(Venta.GeneraCodigo, "00000000")
        Me.txtCliente.Focus()
    End Sub
    ...
    Private Sub btnGuardar_Click(sender As System.Object, e As System.EventArgs) Handles btnGuardar.Click
        ...
        Try
            ...
            If cmbFormaPago.GetColumnValue("id_fopa") = 1 Then
                If Venta.AgregarVenta(gvDetalle) Then
            ...
            ElseIf cmbFormaPago.GetColumnValue("id_fopa") = 3 Then
                ...
                If Venta.AgregarVenta(gvDetalle) = True Then
...
#End Region
    ...
    Private Sub btnAgregar_Click(sender As System.Object, e As System.EventArgs) Handles btnAgregar.Click
        ...
        If Not BuscarDuplicado(Me.txtCodProd.EditValue, gvDetalle, "CODPROD") Then
            ...
            igv = (CDbl(Me.txtPrecio.Text) / 1.18) * 0.18
    ...
    Private Sub cmbDocVenta_EditValueChanged(sender As System.Object, e As System.EventArgs) Handles cmbDocVenta.EditValueChanged
        ...
        If CInt(cmbDocVenta.GetColumnValue("id_dove")) = 3 Then
            Me.chkAuto.Visible = True
        Else
    ...
    Private Sub cmbFormaPago_EditValueChanged(sender As System.Object, e As System.EventArgs) Handles cmbFormaPago.EditValueChanged
    ...
    Private Sub chkAuto_CheckedChanged(sender As System.Object, e As System.EventArgs) Handles chkAuto.CheckedChanged
        If chkAuto.Checked = True Then
            Me.txtNumDoc.EditValue = Format(Venta.GeneraNumeroRecibo(), "000000")
        Else
            Me.txtNumDoc.EditValue = ""
            Me.txtNumDoc.Focus()
        End If
    End Sub

    Private Sub txtNumDoc_LostFocus(sender As Object, e As EventArgs) Handles txtNumDoc.LostFocus

        If Venta.VerificaNumeroRecibo(CInt(cmbDocVenta.GetColumnValue("id_dove")), Me.txtNumDoc.EditValue) = True Then
